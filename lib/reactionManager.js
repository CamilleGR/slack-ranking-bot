...
var getUserReactions = function getUserReactions(db,userId){
  return new Promise(function(resolve, reject){
       db.collection("reactions")
        .find({scores: {$elemMatch: {name: userId}}},{name:1,scores: {$elemMatch: {name:userId}}}).toArray(function(err,docs){
         if(err != null || docs == null) reject(err)
         else resolve(docs)
       })
     })
